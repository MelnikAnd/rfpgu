        ...
        <div class="header-main"  style="@auth margin-top: 30px @endauth">
            <div class="header-columns">
                ...
                <div class="header-column">
                    ...
                    <a href="#" class="bvi-open" title="Версия сайта для слабовидящих" style="font-size:20px; padding-right: 10px" itemprop="copy"><span class="fa fa-eye"></span><span style="display:none">Версия для слабовидящих</span></a>
