...
class PublicController extends BasePublicController
{
    ...
    public function __construct(PostRepository $post, CategoryRepository $category, PageRepository $page, Application $app)
    {
        parent::__construct();
        $this->post = $post;
    ...
    public function homepage()
    {
        ...
        $news_posts = $this->post->whereCategory(2);

        $ann_posts = $this->post->whereCategory(4);

        $events_posts = $this->post->whereCategory(6);

        return view($template, compact('news_posts','ann_posts','events_posts','page', 'alternate'));
    }
